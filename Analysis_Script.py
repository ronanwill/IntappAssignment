...
df_Contacts_T1.to_excel('/Users/ronanwill/DE_Assignment/Clean_DataFiles/ContactsT1.xlsx', sheet_name="Tier 1's", index=False)
df_Contacts_T2.to_excel('/Users/ronanwill/DE_Assignment/Clean_DataFiles/ContactsT2.xlsx', sheet_name="Tier 2's", index=False)
df_Events_LPD.to_excel('/Users/ronanwill/DE_Assignment/Clean_DataFiles/EventsLPD.xlsx', sheet_name="Leaders and Partners Dinner", index=False)
df_Events_MRC.to_excel('/Users/ronanwill/DE_Assignment/Clean_DataFiles/EventsMRC.xlsx', sheet_name="2019 Market Re-Cap", index=False)