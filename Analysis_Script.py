...
df_ConsumerRetail.to_excel('ConsumerRetail.xlsx', index=False)
df_PEComps.to_excel('PEComps.xlsx', index=False)
df_Contacts_T1.to_excel('ContactsT1.xlsx', sheet_name="Tier 1's", index=False)
df_Contacts_T2.to_excel('ContactsT2.xlsx', sheet_name="Tier 2's", index=False)
df_Events_LPD.to_excel('EventsLPD.xlsx', sheet_name="Leaders and Partners Dinner", index=False)
df_Events_MRC.to_excel('EventsMRC.xlsx', sheet_name="2019 Market Re-Cap", index=False)
